    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <!-- <img src="{{ asset('frontend') }}/images/carousel-1.jpg" class="d-block w-100" alt=""> -->
            ...
            <div class="carousel-item">
                <!-- <img src="{{ asset('frontend') }}/images/carousel-3.jpg" class="d-block w-100" alt=""> -->
            ...
            @if(!empty(getCategories()))
                @foreach(getCategories() as $cat)
                    <div class="col-lg-3">
                        <div class="cat-card">
                            <div class="left">
                                <img src="{{ asset('upload') }}/{{ $cat->image }}" alt="" class="img-fluid">
                            </div>
                            <div class="right">
                                <div class="cat-data">
                                    <h2>{{ $cat->name }}</h2>
                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="" class="product-img"><img class="card-img-top" src="{{ asset('upload') }}/{{ $item->image }}" alt=""></a>
